...
* Redirect to a different route on accessing a specific route, `{path: 'something', redirectTo: '/home'     '**' is to catch all generic routes, make sure you defined that route at end.`   { path: '', redirectTo: '/somewhere-else', pathMatch: 'full' } 
### Observables ###
